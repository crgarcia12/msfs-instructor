...
[Flags]
public enum LightOnStateValues
{
    None = 0x0000,
    Nav = 0x0001,
    Beacon = 0x0002,
...
/// <summary>
/// When you change something in this file, in order it gets populated, you must add it to <seealso cref="SimConnector" />
/// </summary>
public class AircraftStatusModel
{
    ...
    public LightOnStateValues LightOnState { get; set; }
    ...
    public AircraftStatusModel(AircraftStatusStruct status)
    {
        ...
        LightOnState = (LightOnStateValues) status.LightOnState;
